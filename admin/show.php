...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>SUN RISE HOTEL,</p>
				<p>ĐHCT<br>Ninh Kiều<br>Cần Thơ.</p>
				<p>(+84) 0373897717</p>
			</address>
		...
		<article>
			...
			<table >
					<tr> 
						<td>SĐT khách hàng : -  <?php echo $phone; ?> </td>
						
						<td>Email khách hàng : -  <?php echo $email; ?> </td>
					</tr>
					<tr> 
						<td>Địa chỉ khách hàng : -  <?php echo $country; ?> </td>
						<td>Quốc tịch khách hàng : -  <?php echo $National; ?> </td>
					</tr>
				</table>
				<br>
				<br>
		...
		<aside>
			...
			<div >
				<p align="center">Email :- hmđ@sunrise.com || Web :- www.sunrise.com || Phone :- +84 0373897717 </p>
			</div>
		</aside>
	</body>
</html>
